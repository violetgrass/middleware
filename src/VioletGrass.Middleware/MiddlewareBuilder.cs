...
{
    private readonly List<Func<MiddlewareDelegate<TContext>, MiddlewareDelegate<TContext>>> _factories = new List<Func<MiddlewareDelegate<TContext>, MiddlewareDelegate<TContext>>>();
